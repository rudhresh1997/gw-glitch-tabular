...
pd.DataFrame(conf_mat, index=class_labels, columns=class_labels).to_csv("./img_danet/confusion_matrix_full.csv")
pd.DataFrame({"class": class_labels, "f1_score": per_class_f1}).to_csv("./img_danet/per_class_f1_full.csv", index=False)
...
ax.set_title("Confusion matrix for DANet (row-normalized)", pad=14)
...
plt.tight_layout()
plt.savefig("./img_danet/conf_matrix_row_normalized_PRD.png", dpi=600, bbox_inches="tight")
plt.savefig("./img_danet/conf_matrix_row_normalized_PRD.pdf", bbox_inches="tight")
plt.close()
...
ax.set_title("Confusion matrix for DANet (raw counts)", pad=14)
ax.set_xlabel("Predicted class")
ax.set_ylabel("True class")
plt.xticks(rotation=45, ha="right")
plt.yticks(rotation=0)
...
plt.tight_layout()
plt.savefig("./img_danet/conf_matrix_counts_PRD.png", dpi=600, bbox_inches="tight")
plt.savefig("./img_danet/conf_matrix_counts_PRD.pdf", bbox_inches="tight")
plt.close()
